...
public class Address {
    ...
    public String getMyWilayaCode() {
        switch (this.city) {
            case "Adrar": return    "01"; 
            case "Chlef": return "02"; 
            case "Laghouat": return "03"; 
            case "Oum El Bouaghi": return "04"; 
            case "Batna": return "05"; 
            case "Béjaïa": return "06"; 
            case "Biskra": return "07"; 
            case "Béchar": return "08"; 
            case "Blida": return "09"; 
